...
class Factory {
  ...
  customerBuild(color, options) {
    console.log('Building ' + 'one ' + color + ' ' + this.model + ' ' +
...
class Car extends Factory {
  constructor(model, trim, color, enginesize, transmission, wheelstrim,
    audio, seattrim, moonroof, doors) {
    super();
    this.model = model;
    this.trim = trim;
    this.color = color;
...
class Sport extends Car {
  constructor(model, trim, color, transmission, top, seattrim, audio, wheelstrim) {
    super(model, trim, color, transmission, top, seattrim, audio, wheelstrim);
...
// Write your code below:
//'Trail Blazer', 'blue', 'Sport', 8, true, 'standard', 2
class Truck extends Factory {
  constructor(model, color, trim, enginesize, hitch, bed, doors) {
    super();
    this.model = model;
    this.color = color;
    this.trim = trim;
...
let car = new Car('mazda3', 'red', 'hybrid', 'automatic', 'touring', 'base',
'premium', 'leather', true);
...
// Write your code below:
let mitaRf = new Sport('Mita-RF', 'Grand Touring', 'red', 'hard top', 'manual',
'leather', 'premium', 'premium');
...
mitaRf.customerBuild('black', ['hid headlights', 'sports suspension',
 'leather steering wheel', 'heated seats', 'adaptive cruise control',]);
...
let trailBlazer = new Truck('Trail Blazer', 'blue', 'Sport', 8, true, 'standard', 2);
